...
fn main() {
    ...
    // let pieces = vec![
    //     Piece::new(vec![(0, 0), (0, 1), (0, 2), (1, 2), (2, 2)]), // A
    //     Piece::new(vec![(2, 0), (2, 1), (1, 1), (0, 1), (0, 2)]), // B
    //     Piece::new(vec![(0, 0), (0, 1), (1, 1), (0, 2), (0, 3)]), // C
    //     Piece::new(vec![(0, 0), (1, 0), (1, 1), (1, 2), (0, 2)]), // D
    //     Piece::new(vec![(2, 0), (2, 1), (1, 1), (1, 2), (0, 1)]), // E
    //     Piece::new(vec![(0, 0), (1, 0), (1, 1), (1, 2), (1, 3)]), // F
    //     Piece::new(vec![(1, 0), (1, 1), (0, 1), (2, 1), (1, 2)]), // G
    //     Piece::new(vec![(1, 0), (1, 1), (0, 1), (0, 2), (0, 3)]), // H
    //     Piece::new(vec![(1, 0), (0, 1), (1, 1), (0, 2), (1, 2)]), // I
    //     Piece::new(vec![(2, 0), (2, 1), (1, 1), (1, 2), (0, 2)]), // J
    //     Piece::new(vec![(2, 0), (2, 1), (1, 1), (0, 1), (2, 2)]), // K
    //     Piece::new(vec![(0, 0), (0, 1), (0, 2), (0, 3), (0, 4)]), // L
    // ];
    ...
    let result = solve(pieces, grid_mask, Some(false), Some(true));
    match result {
